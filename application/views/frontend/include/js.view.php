...
var scrolltotop={
	...
	controlHTML: '<img src="<?php echo base_url() ?>assets/frontend/template_content/assets/img/up.png" style="width:40px; height:40px" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
